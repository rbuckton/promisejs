...
export class Uri {
	 ...
	 */
	public isSameOrigin(uri: Uri): bool;
	 ...
	 * @returns {Boolean} True if the uri's have the same origin; otherwise, false
	 */
	public isSameOrigin(uri: string): bool;

	public isSameOrigin(uriAny: any): bool {
